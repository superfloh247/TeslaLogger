...
WHERE
    id = @id", con))
        ...
        // UpdateCarIDNull moved to DBHelper.Optimization.cs
...
ORDER BY
    StartDate ASC", con))
        ...
        [SuppressMessage("Security", "CA2100:Review SQL queries for security vulnerabilities")]
        // IndexExists moved to DBHelper.Optimization.cs
...
WHERE
    ...
    AND charger_voltage > 300";
        ...
        // MigrateFloorRound moved to DBHelper.Optimization.cs
...
", con))
        ...
        // MigratePosOdometerNullValues moved to DBHelper.Optimization.cs
        ...
        // UpdateAllPOS_AP_Column moved to DBHelper.Optimization.cs
        // DuplicatePos moved to DBHelper.Optimization.cs
